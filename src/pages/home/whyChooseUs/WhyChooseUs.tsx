...
const WhyChooseUs = () => {
    ...
    return (
        <div>
            ...
            <div className="mt-6 lg:mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {features.map((item, index) => (
                    <motion.div
                        ...
                        className="group px-6 pt-10 pb-8 border border-[#73737333] bg-white hover:bg-[#E63946] transition-all duration-300 rounded-2xl flex flex-col items-center justify-center text-center cursor-pointer"
                    >
